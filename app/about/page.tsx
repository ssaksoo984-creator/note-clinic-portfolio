...
export const metadata: Metadata = {
  title: "병원소개 | 아르떼성형외과",
  description: "자연스러운 아름다움을 완성하는 아르떼성형외과의 철학과 히스토리",
};
...
const milestones = [
  { year: "2013", description: "아르떼성형외과 강남점 개원" },
  ...
  return (
    <>
      <PageHero
        en="ABOUT ARTE"
        title="병원소개"
        description="자연스러운 아름다움을 완성하는 아르떼성형외과의 철학을 소개합니다."
      />

      <PhilosophyDetail
        lead="원래 그 사람이었던 것처럼"
        description="아르떼성형외과는 화려함보다 조화를, 과감함보다 섬세함을 추구합니다. 자연스러움이야말로 가장 완성도 높은 아름다움이라 믿으며, 개인의 고유한 매력을 살리는 것을 최우선 가치로 삼습니다."
        values={values}
      />
